 ...
 #define VGA_SR04_SEQ_MODE       0x04 /* bit 2: directs system to use a sequential addressing mode 171 #define VGA_SR04_CHN_4M         0x08  bit 3: selects modulo 4 addressing for CPU access to diay memory */
