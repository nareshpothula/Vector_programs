...
char *c[]={"","","hundred","thousand","thousand","lakh","lakhs","crore","crore","hundread and","thousand","thousand","lakh","lakh"};
int flag=0;
char q[100];
unsigned long long int d,e;
int k=0,i=0,n,f[215],count=0,j=0,r;
main()
{
